    ...
    <body>
        ...
        <div class="content" id="training">
            <div class="w3-sidebar w3-card">
                <a href="./Appointment" class="w3-bar-item w3-button">Create Appointment</a>
                <a href="./edit-appointment.jsp" class="w3-bar-item w3-button">Edit Appointment</a>
                <a href="./delete-appointment.jsp" class="w3-bar-item w3-button">Delete Appointment</a>
                <a href="./boarding/CreateBoarding" class="w3-bar-item w3-button">Create Boarding</a>
                <a href="./boarding/LoadBoarding" class="w3-bar-item w3-button">Edit Boarding</a>
                <a href="./boarding/delete-boarding.jsp" class="w3-bar-item w3-button">Delete Boarding</a>
            </div>
        </div>
        <div class="footer">
            <footer>
