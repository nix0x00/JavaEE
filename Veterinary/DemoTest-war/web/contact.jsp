...
<nav>
    <div>
        ...
        <a class="link gray selected" href="./contact.jsp#contactUs">Contact</a>
...
<div class="content" id="contact">
    <a name='contactUs'>
        <p>Thanks for contacting APU Veterinary Clinic! While we strive to respond to every inquiry as quickly as possible,
            please allow up to 48 hours to receive a response.</p>
        <br/><p>If your matter is of an urgent nature, please call us at 000-111-2222.</p><br/>
        <form method="post" action="/SendEmail">
            ...
            <strong>Phone<span color="red">*</span></strong><strong id="emailSpace">Email<span color="red">*</span></strong><br />
            <input type="tel" name="tel" placeholder="e.g 0173787324" size="30" />&nbsp; <input type="email" name="email" placeholder="e.g jimmy@example.com" size="30" />
            <br /><br />
            <strong>Message<span color="red">*</span></strong><br />
            <textarea placeholder="Enter your message here.." name="message" rows="8" cols="64" maxlength="400"></textarea>
            <br />
